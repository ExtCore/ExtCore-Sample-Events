# ExtCore Framework 1.2.0-beta1 Sample Web Application That Uses Events
...
* set the correct project path in the `SomeActionEventHandler` class of the `ExtensionB` project.
